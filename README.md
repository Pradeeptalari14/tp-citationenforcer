...
> Entailment evaluator ensuring output citations map directly to valid source indices.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/citationenforcer/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-citationenforcer.git
cd tp-citationenforcer
```
...
```bash
kubectl port-forward deployment/tp-citationenforcer 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── citation_verifier.py     # Main configuration file
```
...
---
*Generated by [CitationEnforcer Studio](https://pradeeptalari14.github.io/portfolio/tools/citationenforcer/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
